// Initialize Lucide Icons
        ...
        function switchTab(toLogin) {
            ...
            if (toLogin) {
                loginTab.className = 'flex-1 py-2 text-sm font-medium rounded-lg transition-all bg-white dark:bg-gray-700 shadow-sm text-gray-900 dark:text-white';
                registerTab.className = 'flex-1 py-2 text-sm font-medium rounded-lg transition-all text-gray-500 dark:text-gray-400';
                ...
                registerTab.className = 'flex-1 py-2 text-sm font-medium rounded-lg transition-all bg-white dark:bg-gray-700 shadow-sm text-gray-900 dark:text-white';
                loginTab.className = 'flex-1 py-2 text-sm font-medium rounded-lg transition-all text-gray-500 dark:text-gray-400';
